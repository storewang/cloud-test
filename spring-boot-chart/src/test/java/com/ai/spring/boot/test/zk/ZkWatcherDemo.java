...
public class ZkWatcherDemo {
    ...
    public void testNodeCache() {
        ...
        //检查节点是否存在，没有则创建
        boolean isExist = CuratorZKclient.instance.isNodeExist(workerPath);
        if (!isExist) {
            CuratorZKclient.instance.createNode(workerPath, null);
        }
...
//            client.delete().forPath(workerPath);
    ...
    public void testPathChildrenCache() {
        ...
        try {
            ...
            Thread.sleep(1000);
            for (int i = 0; i < 3; i++) {
                CuratorZKclient.instance.createNode(subWorkerPath + i, null);
            }

            Thread.sleep(1000);
            for (int i = 0; i < 3; i++) {
                CuratorZKclient.instance.deleteNode(subWorkerPath + i);
            }
    ...
    public void testTreeCache() {
        ...
        try {
            ...
            CuratorZKclient.instance.deleteNode(workerPath);
